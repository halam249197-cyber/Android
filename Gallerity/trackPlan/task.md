...
- [x] **Giai đoạn 2: Tích hợp ML Offline & Quản lý Album**
...
- [x] **Giai đoạn 2.5: Bottom Navigation, Onboarding & Calendar**
  ...
  - [x] Khi bấm vào Lịch: Trượt sang màn hình mới (`DayPhotosScreen`).
  - [x] Cấu hình Strict Lock cho Tab Security (Rời Tab tự động khóa lại).

- [x] **Giai đoạn 3: Xem chi tiết ảnh, Chỉnh sửa & Cài đặt**
  - [x] Màn hình chi tiết ảnh (Fullscreen, Zoom, Swipe giữa các ảnh).
  - [x] Nút Share, Delete, Info (metadata BottomSheet).
